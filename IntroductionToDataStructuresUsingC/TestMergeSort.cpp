...
namespace test_merge_sort
{
	...
	void Test(ECaseNum case_num, ESortOrder sort)
	{
		...
		{
			std::cout << "MergeSort() (Ascending)";
			algorithm::MergeSort(test_cases[case_num], algorithm::compare::Less<int>());
		}
		else
		{
			std::cout << "MergeSort() (Descending)";
			algorithm::MergeSort(test_cases[case_num], algorithm::compare::Greater<int>());
		}
