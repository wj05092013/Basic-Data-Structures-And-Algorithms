...
namespace test_insertion_sort
{
	...
	void Test(ECaseNum case_num, ESortOrder sort)
	{
		...
		{
			std::cout << "InsertionSort() (Ascending)";
			algorithm::InsertionSort(test_cases[case_num], algorithm::compare::Less<int>());
		}
		else
		{
			std::cout << "InsertionSort() (Descending)";
			algorithm::InsertionSort(test_cases[case_num], algorithm::compare::Greater<int>());
		}
